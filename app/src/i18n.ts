...
attachPhoto: { ml: "ഫോട്ടോ ചേർക്കുക", en: "Attach a photo" },
  ...
  skillNotListedPlaceholder: { ml: "പട്ടികയിലില്ലാത്ത നൈപുണ്യം ടൈപ്പ് ചെയ്യൂ", en: "Skill not in the list? Type it" },
  addSkillButton: { ml: "ചേർക്കുക", en: "Add" },
  ...
  sortByScore: { ml: "സ്‌കോർ അനുസരിച്ച്", en: "Sort by score" },
  matchScore: { ml: "പൊരുത്ത സ്‌കോർ", en: "Match score" },
  autoSelect: { ml: "സ്വയമേവ തിരഞ്ഞെടുക്കുക", en: "Auto select" },
  algorithmSuggests: { ml: "അൽഗോരിതം നിർദ്ദേശിക്കുന്നത്", en: "The algorithm suggests" },
  finalize: { ml: "സ്ഥിരീകരിക്കുക", en: "Finalize" },
  assignedTo: { ml: "ചുമതലപ്പെടുത്തിയത്", en: "Assigned to" },
  yrs: { ml: "വർഷം", en: "yrs" },
  ...
  coordinatorPending: { ml: "മറുപടി കാത്തിരിക്കുന്നു", en: "Waiting for her answer" },
  coordinatorDeclined: { ml: "നിരസിച്ചു", en: "Declined" },
  waitingSince: { ml: "മുതൽ കാത്തിരിക്കുന്നു", en: "waiting since" },
  coordinatorInviteHeading: { ml: "നിങ്ങളെ ചുമതലക്കാരിയായി തിരഞ്ഞെടുത്തു", en: "You've been appointed coordinator" },
  coordinatorInviteBody: {
    ml: "ഈ ജോലിയുടെ വില, മാതൃക, ഒപ്പ് എന്നിവയുടെ ചുമതല നിങ്ങൾക്കാകും.",
  ...
  removeSkill: { ml: "നൈപുണ്യം നീക്കുക", en: "Remove skill" },
  confirmRemoveSkill: { ml: "ഈ നൈപുണ്യം നീക്കണോ?", en: "Remove this skill?" },
