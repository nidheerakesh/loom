...
> Two layers. A 52-check manual runbook covering every user journey, and 125 automated checks that
...
| Testing | **125 automated checks against production, all passing** |
