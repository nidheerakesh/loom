# Screenshots for docs/PROGRESS.md

Save each capture here under the exact filename below — §8 of the report references them by
these names, so a rename breaks the report.
